...
export const PIPELINE_STEPS: PipelineStep[] = [
  ...
  { id: "deploy-sandbox", label: "Sandbox", subtitle: "Sandbox env", icon: Rocket },
  ...
  { id: "deploy", label: "Deploy", subtitle: "Ship to production", icon: CloudUpload },
  { id: "user-test", label: "End User Test", subtitle: "AI agent testing", icon: Bot },
];
